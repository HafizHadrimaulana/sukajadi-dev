        ...
        <div class="card-body">
            <form id="form-kegiatan" method="POST" action="{{ route('admin.kegiatan.update', $data->id_t_kegiatan) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control bg-white {{ $errors->has('tgl', $data->tanggal_t_kegiatan) ? 'is-invalid' : '' }}" name="tgl" id="field-tgl" placeholder="Masukan Tanggal">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('volume') ? 'is-invalid' : '' }}" name="volume" id="volume" value="{{ old('volume', $data->volume_t_kegiatan) }}" placeholder="Masukan Volume">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('lokasi') ? 'is-invalid' : '' }}" name="lokasi" id="field-lokasi" placeholder="Masukan Lokasi / Alamat" value="{{ old('volume', $data->lokasi_t_kegiatan) }}">
...
<script src="https://unpkg.com/leaflet-geosearch@3.11.0/dist/geosearch.umd.js"></script>
    <script>
        ...
        $(document).ready(function() {
            ...
            var map = L.map('map').setView(["{{ $data->lat_t_kegiatan ?? '-6.885096440972612' }}", "{{ $data->lng_t_kegiatan ?? '107.58568634441774' }}"], 14);
