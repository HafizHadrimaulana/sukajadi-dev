            ...
            <div class="col-lg-3 col-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-bs-toggle="collapse"
                                data-bs-target="#agenda"><i class="fas fa-minus"></i>
                            </button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    ...
                    <div class="card-footer text-center">
                        <a href="https://sukajadi.bandung.go.id/portal/admin/agenda/agenda_kalender" class="stretched-link">
                            Lihat semua Agenda 
                            <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools ms-auto">
                            <select id="tahun_grafik_surat" onchange="pilihan_tahun_grafik_surat()"
            ...
            <script>
                ...
                function pilih_tahun_grafik_surat(tahun_grafik_surat) {
                    ...
                    fetch(url)
                        ...
                        .then(data => {
                            var labels = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus',
                            ...
                            var chart = new Chart(ctx, {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                            label: 'Agenda',
                                            stack: 'stack',
                                            backgroundColor: "#52d9ce",
                                            data: value_jumlah_agenda
                                        },
                                        {
                                            label: 'Masuk',
                                            stack: 'stack',
                                            backgroundColor: "#98e78f",
                                            data: value_jumlah_surat_masuk
                                        },
                                        {
                                            label: 'Keluar',
                                            stack: 'stack',
                                            backgroundColor: "#f6cf58",
                                            data: value_jumlah_surat_keluar
                                        }
                                    ]
                                },
                                options: {
            ...
            <div class="col-lg-3 col-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            <select id="tahun_pie_surat" class="form-select form-select-sm"
                                onchange="pilihan_tahun_pie_surat()">
                                <option value="4">2023</option>
                                <option value="3">2022</option>
                                <option value="2">2021</option>
                                <option value="1">2020</option>
